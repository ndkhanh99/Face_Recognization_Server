...
def regFaces():
    ...
    if message == 'true':
        input_dir = '/Users/macbook/Desktop/attendanceServer/backend/data/raw'
        output_dir = '/Users/macbook/Desktop/attendanceServer/backend/data/proceed'
        image_size = 160
        margin = 32
...
def startTraining():
    ...
    message = request.form['status']
    if message == 'true':
        data_dir = '/Users/macbook/Desktop/attendanceServer/backend/data/proceed'
        args = {'mode':'TRAIN', 
         'data_dir':data_dir, 
         'model':'/Users/macbook/Desktop/attendanceServer/backend/models/20180402-114759.pb', 
         'classifier_filename':'/Users/macbook/Desktop/attendanceServer/backend/models/facemodel.pkl', 
